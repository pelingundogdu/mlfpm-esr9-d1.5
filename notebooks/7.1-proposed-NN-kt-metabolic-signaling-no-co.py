...
for i_scaling in TYPE_OF_SCALING:
    ...
    ss_dense_model.save(os.path.join(path_model+str('/ss_dense_model_metabolic_signaling')))

    ss_a1_model.save(os.path.join(path_model+str('/ss_a1_model_metabolic_signaling')))
    ss_a2_model.save(os.path.join(path_model+str('/ss_a2_model_metabolic_signaling')))

    ss_b1_model.save(os.path.join(path_model+str('/ss_b1_model_metabolic_signaling')))
    ss_b2_model.save(os.path.join(path_model+str('/ss_b2_model_metabolic_signaling')))
    ...
    df_hp.to_csv(os.path.join(path_output_result+'/kt_hyperparameters_metabolic_signaling_no_co_'+str(i_scaling)+'.txt'), sep=';')
