...
for i_row_scaling in TYPE_OF_SCALING:
    ...
    ss_a2_model, _ = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
                                                        , y_train_=array_train_y_ss
                                                        , X_test_=array_test_X_ss
                                                        , y_test_=array_test_y_ss
                                                        , df_w_=df_weight_metabolic_signaling
    ...
    ss_dense_model.save(os.path.join(path_model+str('/ss_dense_model_met_sig')))

    ss_a1_model.save(os.path.join(path_model+str('/ss_a1_model_met_sig')))
    ss_a2_model.save(os.path.join(path_model+str('/ss_a2_model_met_sig')))

    ss_b1_model.save(os.path.join(path_model+str('/ss_b1_model_met_sig')))
    ss_b2_model.save(os.path.join(path_model+str('/ss_b2_model_met_sig')))
