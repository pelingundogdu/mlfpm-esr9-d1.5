...
#     path_hyperband_ = ''
    ...
    print('Metabolic and Signaling with StandardScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways'+str(len(df_weight_metabolic_signaling.columns)))
    ss_a1_model, ss_a1_metric, ss_a1_hp = tfm_kt.TFM_KerasTunerExperiment(X_train_=array_train_X_ss
                                                                          ...
                                                                          , bio_='pathway_'
                                                                          , design_name_='met_sig_SScaler_1_layer_'
                                                                          , directory_='met_sig_kt_ss_a1_pathway'
    ...
    # ## with 2-LAYER
    # ### StandardScaler normalization - Pathways connection + Fully connected - metabolic and signaling + ???? dense
    print('Metabolic and Signaling with StandardScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways'+str(len(df_weight_metabolic_signaling.columns))+' + dense ????')
    ss_a2_model, ss_a2_metric, ss_a2_hp = tfm_kt.TFM_KerasTunerExperiment(X_train_=array_train_X_ss
                                                                          ...
                                                                          , df_w_=df_weight_metabolic_signaling
                                                                          , bio_='pathway_'
                                                                          , design_name_='met_sig_SScaler_2_layer_'
                                                                          , directory_='met_sig_kt_ss_a2_pathway'
    ...
    ss_b1_model, ss_b1_metric, ss_b1_hp = tfm_kt.TFM_KerasTunerExperiment(X_train_=array_train_X_ss
                                                                          ...
                                                                          , design_name_='met_sig_SScaler_1_layer_'
                                                                          , directory_='met_sig_kt_ss_b1_pathway_ppi'
    ...
    print('Metabolic and Signaling with StandardScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways_ppi_tf'+str(df_weight_both.shape[1])+' + dense ????')
    ss_b2_model, ss_b2_metric, ss_b2_hp = tfm_kt.TFM_KerasTunerExperiment(X_train_=array_train_X_ss
                                                                          ...
                                                                          , bio_='ppi_tf_pathway_'
                                                                          , design_name_='met_sig_SScaler_2_layer_'
                                                                          , directory_='met_sig_kt_ss_b2_pathway_ppi'
    ...
    df_metrics.to_csv(os.path.join(path_output_result+'/kt_score_metabolic_signaling_'+n_out_cell_type+'.txt'), sep=';')
    print('RESULT EXPORTED to "{}"'.format(path_output_result))

    ss_dense_model.save(os.path.join(path_model_cell_out+str('/ss_dense_model_metabolic_signaling')))

    ss_a1_model.save(os.path.join(path_model_cell_out+str('/ss_a1_model_metabolic_signaling')))
    ss_a2_model.save(os.path.join(path_model_cell_out+str('/ss_a2_model_metabolic_signaling')))

    ss_b1_model.save(os.path.join(path_model_cell_out+str('/ss_b1_model_metabolic_signaling')))
    ss_b2_model.save(os.path.join(path_model_cell_out+str('/ss_b2_model_metabolic_signaling')))
    ...
    df_hp.to_csv(os.path.join(path_output_result+'/kt_hyperparameters_metabolic_signaling_'+n_out_cell_type+'.txt'), sep=';')
    print('RESULT EXPORTED to "{}"'.format(path_output_result))
