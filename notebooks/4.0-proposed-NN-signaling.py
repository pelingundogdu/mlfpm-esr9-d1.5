...
for i_row_scaling in TYPE_OF_SCALING:
    ...
    for i_experiment in list_experiments:
        ...
        #     design21_dense_model, design21_dense_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
        ...
        print('Signaling with MinMaxScaler normalization - '+str(df_weight_both.shape[0])+' gene - dense100')
        #     design22_dense_model, design22_dense_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
        mms_dense_model, mms_dense_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
                                                                  ...
                                                                  , df_w_=pd.DataFrame()
                                                                  , bio_='dense_'
                                                                  , design_name_='signaling_MMScaler_1_layer_100'
                                                                  , pathway_layer_=False
                                                                  , second_layer_=False
                                                                  , epochs_=epochs_default
                                                                  , batch_size_=batch_size_default
        ...
        #     design24_A1layer_pathway_model, design24_A1layer_pathway_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
        ...
        # ### MinMaxScaler normalization - Pathways connection - 92 signaling
        print('Signaling with MinMaxScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways'+str(unit_size))
        #     design25_A1layer_pathway_model, design25_A1layer_pathway_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
        ...
        #     design24_A2layer_pathway_model, design24_A2layer_pathway_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
        ...
        # ### MinMaxScaler normalization - Pathways connection + Fully connected - 92 signaling + 100 dense
        print('Signaling with MinMaxScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways'+str(unit_size)+' + dense100')
        #     design25_A2layer_pathway_model, design25_A2layer_pathway_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
        mms_a2_model, mms_a2_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
                                                            ...
                                                            , df_w_=df_weight_signaling
                                                            , bio_='pathway_'
                                                            , design_name_='signaling_MMScaler_2_layer_'+str(unit_size)
                                                            , pathway_layer_=True
                                                            , second_layer_=True
                                                            , epochs_=epochs_default
                                                            , batch_size_=batch_size_default
        ...
        #     design24_B1layer_pathway_ppi_model, design24_B1layer_pathway_ppi_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
        ...
        # ### MinMaxScaler normalization - Pathways and PPI/TF connection - 769 nodes
        print('Signaling with MinMaxScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways_ppi_tf'+str(df_weight_both.shape[1]))
        #     design25_B1layer_pathway_ppi_model, design25_B1layer_pathway_ppi_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
        ...
        #     design24_B2layer_pathway_ppi_model, design24_B2layer_pathway_ppi_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_ss
        ...
        # ### MinMaxScaler normalization - Pathways and PPI/TF connection + Fully connected - 769 nodes + 100 dense
        print('Signaling with MinMaxScaler normalization - '+str(df_weight_both.shape[0])+' gene - pathways_ppi_tf'+str(df_weight_both.shape[1])+' + dense100')
        #     design25_B2layer_pathway_ppi_model, design25_B2layer_pathway_ppi_metric = tfm_NN.TFM_NNExperiment(X_train_=array_train_X_mms
        ...
        df_metrics.to_csv(os.path.join(path_output+'/design_A_B_signaling_'+n_out_cell_type+'.txt'), sep=';')
        ...
        mms_dense_model.save(os.path.join(path_model_cell_out+str('/mms_dense_model_signaling')))

        ss_a1_model.save(os.path.join(path_model_cell_out+str('/ss_a1_model_signaling')))
        mms_a1_model.save(os.path.join(path_model_cell_out+str('/mms_a1_model_signaling')))
        ss_a2_model.save(os.path.join(path_model_cell_out+str('/ss_a2_model_signaling')))
        mms_a2_model.save(os.path.join(path_model_cell_out+str('/mms_a2_model_signaling')))

        ss_b1_model.save(os.path.join(path_model_cell_out+str('/ss_b1_model_signaling')))
        mms_b1_model.save(os.path.join(path_model_cell_out+str('/mms_b1_model_signaling')))
        ss_b2_model.save(os.path.join(path_model_cell_out+str('/ss_b2_model_signaling')))
        mms_b2_model.save(os.path.join(path_model_cell_out+str('/mms_b2_model_signaling')))
